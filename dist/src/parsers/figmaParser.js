...
class FigmaParser {
    ...
    parseFigmaJSON(input) {
        try {
            ...
            return {
                document: {
                    children: data.document.children.map((node) => this.validateNode(node))
                },
...
exports.FigmaParser = FigmaParser;
//# sourceMappingURL=figmaParser.js.map